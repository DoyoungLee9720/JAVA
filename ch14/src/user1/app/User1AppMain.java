...
public class User1AppMain extends JFrame {
	...
	public User1AppMain() {
		...
		List<User1VO> users = dao.selectuUsers();
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//등록화면으로 전환
				CardLayout cardLaout = (CardLayout)contentPane.getLayout();
				cardLaout.show(getContentPane(), "registerPanel");
		...
		lblNewLabel_2.setBounds(10, 25, 57, 15);
		registerPanel.add(lblNewLabel_2);
		
		txtUid = new JTextField();
		txtUid.setBounds(79, 22, 116, 21);
		registerPanel.add(txtUid);
		txtUid.setColumns(10);
		
		JLabel lblNewLabel_2_1 = new JLabel("이름");
		lblNewLabel_2_1.setBounds(10, 53, 57, 15);
		registerPanel.add(lblNewLabel_2_1);
		
		txtName = new JTextField();
		txtName.setColumns(10);
		txtName.setBounds(79, 50, 116, 21);
		registerPanel.add(txtName);
		
		JLabel lblNewLabel_2_1_1 = new JLabel("생년월일");
		lblNewLabel_2_1_1.setBounds(10, 87, 57, 15);
		registerPanel.add(lblNewLabel_2_1_1);
		
		txtBirth = new JTextField();
		txtBirth.setColumns(10);
		txtBirth.setBounds(79, 84, 116, 21);
		registerPanel.add(txtBirth);
		
		JLabel lblNewLabel_2_1_2 = new JLabel("휴대폰");
		lblNewLabel_2_1_2.setBounds(10, 123, 57, 15);
		registerPanel.add(lblNewLabel_2_1_2);
		
		txtHp = new JTextField();
		txtHp.setColumns(10);
		txtHp.setBounds(79, 120, 116, 21);
		registerPanel.add(txtHp);
		
		JLabel lblNewLabel_2_1_3 = new JLabel("나이");
		lblNewLabel_2_1_3.setBounds(10, 155, 57, 15);
		registerPanel.add(lblNewLabel_2_1_3);
		
		txtAge = new JTextField();
		txtAge.setColumns(10);
		txtAge.setBounds(79, 152, 116, 21);
		...
		btnInsert.setBounds(105, 190, 90, 23);
		...
		btnList.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//등록화면으로 전환
				CardLayout cardLaout = (CardLayout)contentPane.getLayout();
				cardLaout.show(getContentPane(), "listPanel");
			}
		});
		btnList.setBounds(12, 190, 90, 23);
